	...
	<div class="row clearfix">
        ...
        <br>
            <div style="position: relative;">
                <img class="img-circle"  src="../image/szu/szulogo.jpg">
                <h1 style="position: absolute;left: 250px;top: 80px;">深圳大学美食论坛</h1>
            </div>
			<h3 >
				<br>Please login
			</h3> 
			<form id="f" class="form-horizontal" role="form" method="post" action="../overlook_food/register_save.php">
				<div class="form-group">
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<div class="checkbox">
							 <label><input id="ch" type="checkbox" />Sign in as Admin</label>
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						 <button type="submit" class="btn btn-default" onclick="login_click()">Sign in</button>
