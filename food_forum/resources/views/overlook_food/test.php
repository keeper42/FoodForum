...
First name: <input type="month" name="fname" /><br />
Last name: <input type="time" name="lname" /><br />
<input type="submit" value="提交" />
</form>

   <?php include 'register.php' ;?>
    <?php include 'register_success.php'; ?>
    <?php include '../search/search.php' ;?>
    <?php include 'register_user.php'; ?>
    <?php include 'register_user_save_success.php' ;?>
    <?php
        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                ?>
                    ...
                    <li><a href="exit.php"><span class="glyphicon glyphicon-log-out"></span> 退出</a></li> 
