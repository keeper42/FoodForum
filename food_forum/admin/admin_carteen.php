		...
		<div class="col-md-12 column">
			...
			<table class="table table-hover"style="color:white;text-align:front;">
				...
				<tbody>
					...
					?>
                        <form class="form-horizontal" action="modify.php?id=<?php echo $row['ID']?>&i=<?php echo $i?>" method="post">
						<tr>
						<td>
							<?php echo $row['ID']; ?>
						</td>
						<td>
							<input  type="text" class="form-control" size="3" style="text-align: center;background:none;border:0;color: white;"  name = 'name<?php echo $i?>'  id="name" value="<?php echo $row['name']; ?>" >
						</td>
                        <td>
                            <input  type="text" class="form-control" size="1" style="text-align: center;background:none;border:0;color: white;"  name = 'region<?php echo $i?>'  id="region" value="<?php echo $row['region']; ?>" >
                        </td>
                        <td>
                            <input  type="text" class="form-control" size="1" style="text-align: center;background:none;border:0;color: white;"  name = 'grade<?php echo $i?>'  id="grade" value="<?php echo $row['grade']; ?>" >
                        </td>
                        <td>
                            <input  type="text" class="form-control" size="1" style="text-align: center;background:none;border:0;color: white;"  name = 'santiation<?php echo $i?>'  id="santiation" value="<?php echo $row['santiation']; ?>">
                        </td>
						<td>
							<input  type="text" class="form-control" size="7" style="text-align: center;background:none;border:0;color: white;"  name = 'intruduce<?php echo $i?>'  id="intruduce" value="<?php echo $row['intruduce']; ?>" >
						</td>
						<td>
							<button type="submit" class="btn btn-default"/>修改
						</td>
						<td>
							<a href="delete_carteen.php?id=<?php echo $row['ID'] ?>"><button type="button" class="btn btn-default"/>删除
						</td>
					</tr>
                    </form>
					<?php } ?>
...
<nav class="navbar navbar-default" role="navigation" style="margin: 0;position: absolute;top: 0;width: 100%;">
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                ?>
                    <li><a href="#" data-toggle="modal" data-target="#carteenM"><span class="glyphicon glyphicon-plus"></span> 添加食堂</a></li>
